...
namespace FacturacionCine
{
    public partial class frmProcesoReserva : Form
    {
        ...
        private void frmProcesoReserva_Load(object sender, EventArgs e)
        {
            ...
            dgvClientes.Columns[2].Width = 175;
            dgvClientes.Columns[3].Width = 175;
            dgvClientes.Columns[4].Width = 175;
        ...
        private void obtenerSala(object sender, EventArgs e)
        {
            if (cboFuncion.SelectedValue != null)
            {
                ...
                cboTipoEntraba.DataSource = consultaTipoEntrada;
                cboTipoEntraba.DisplayMember = "NOMBRE";
                cboTipoEntraba.ValueMember = "IDTIPOENTRADA";
                dgvButacas.Columns[0].Width = 275;
                dgvButacas.Columns[1].Width = 275;
                dgvButacas.Columns[2].Width = 275;
                dgvButacas.Columns[3].Width = 275;
            }
        }
        ...
        private void listarDetalle()
        {
            ...
            dgvDetalleReserva.Columns[0].Width = 150;
            dgvDetalleReserva.Columns[1].Width = 150;
            dgvDetalleReserva.Columns[2].Width = 150;
            dgvDetalleReserva.Columns[3].Width = 150;
            dgvDetalleReserva.Columns[4].Width = 150;
        }
